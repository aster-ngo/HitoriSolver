...
public class HitoriUI extends JFrame implements ActionListener, ItemListener{
	...
	private static String rulePlay;
	...
	public HitoriUI(){
		sizeBoard = 5;
		rulePlay = "<html><b>Rule of Hitori:</b><br>&nbsp;&nbsp;&nbsp;1. Color cells so no number appears more than once in a row or column. <br>"
				+ "&nbsp;&nbsp;&nbsp;2. The sides of black cells never touch. <br>"
				+ "&nbsp;&nbsp;&nbsp;3. White cells form a continuous network.</html>";
		initComponent();
	}
	...
	public void initComponent(){
		...
		try{
			UIManager.put("ScrollBarUI", "duongngo.hitori.com.MyScrollBarUI");
